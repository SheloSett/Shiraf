 ...
 */
// 5/9/2026 — se mudó adentro de Configuración: el archivo pasó de
// admin.contenido.tsx a admin.configuracion.contenido.tsx, y la ruta la fija
// el nombre del archivo, así que esta cadena tiene que coincidir. La dirección
// vieja, /admin/contenido, sigue existiendo sólo para redirigir acá (ver
// admin.contenido.tsx). La línea vieja queda comentada por la regla de este
// repo.
//   export const Route = createFileRoute("/_authenticated/admin/contenido")({
export const Route = createFileRoute("/_authenticated/admin/configuracion/contenido")({
  head: () => ({
...
function AdminContenido() {
  ...
  return (
    <div>
      {/* 5/9/2026 — la línea chica dice de dónde cuelga la pantalla, que ahora
          es Configuración. Lo que decía antes:
