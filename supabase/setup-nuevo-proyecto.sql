-- ============================================================================
-- Shiraf — setup completo para un proyecto Supabase nuevo.
--
-- Pegar TODO este archivo en el SQL Editor del proyecto nuevo y ejecutar.
-- Es la union de las 5 migraciones de supabase/migrations/ en orden
-- cronologico, generado automaticamente. No editar a mano: si cambian las
-- migraciones, volver a generarlo.
--
-- Crea: tablas, RLS, triggers, funciones y los datos de ejemplo
-- (servicios, profesionales, horarios y productos).
--
-- El rol admin NO se crea aca: ver supabase/crear-admin.sql, que se corre
-- DESPUES de registrarte en la app.
-- ============================================================================


-- ─────────────────────────────────────────────────────────────────────────
-- 20260805164122_5330820c-78f6-4db0-b3df-aefe9583a546.sql
-- ─────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────
-- 20260805164143_b3a06845-a791-46aa-80a7-bf5cb42e76fe.sql
-- ─────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────
-- 20260805165256_f6af6509-092f-4d83-8431-344f736400fb.sql
-- ─────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────
-- 20260805165325_273ae76e-41bc-4388-ad27-71ee09fb1ec4.sql
-- ─────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────
-- 20260805165527_3aa9d2c8-2a5c-47dd-99da-cd7d6b461a58.sql
-- ─────────────────────────────────────────────────────────────────────────
